...
| :--- | :--- |
| <pre>1. alex<br>2. sunshine<br>3. emma<br>4. haskell<br>5. alex<br>6. thunderstorm</pre> | <pre>Enter username:<br>Enter password:<br>You have successfully logged in!<br>Enter username:<br>Enter password:<br>You have successfully logged in!<br>Enter username:<br>Enter password:<br>Incorrect username or password!</pre> |
