...
Write a program that prompts the user with `"What's your name?"`. When the user provides their name, print `"Hi "` followed by the name.
...
```bash
./gradlew test --tests "part01.s03readinginput.exercises.GreetingTest"
```
