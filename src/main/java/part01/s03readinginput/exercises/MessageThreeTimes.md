...
Write a program that prompts the user for a string and prints that string three times.
...
```bash
./gradlew test --tests "part01.s03readinginput.exercises.MessageThreeTimesTest"
```
