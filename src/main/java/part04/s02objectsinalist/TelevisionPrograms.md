...
| :--- | :--- |
| <pre>1. Rick and Morty<br>2. 25<br>3. Two and a Half Men<br>4. 30<br>5. Love it or list it<br>6. 60<br>7. House<br>8. 60</pre> | <pre>Name:<br>Duration:<br>Name:<br>Duration:<br>Name:<br>Duration:<br>Name:<br>Duration:</pre> |
| <pre>30</pre> | <pre>Program's maximum duration?<br>Rick and Morty, 25 minutes<br>Two and a Half Men, 30 minutes</pre> |
