...
In a card game, hands are ranked based on the sum of values of its cards. Modify the `Hand` class to be comparable based on this criteria, i.e. change the class so that interface `Comparable` applies to it.
...
public class SortBySuit implements Comparator {
...
| :--- | :--- |
| Program execution | <pre>DIAMOND 2<br>SPADE A<br>HEART Q<br>DIAMOND 2<br>SPADE A<br>HEART Q<br>SPADE 2<br>DIAMOND 2<br>SPADE 2<br>HEART Q<br>SPADE A<br>better hand is<br>DIAMOND J<br>SPADE J<br>HEART J<br>DIAMOND 2<br>HEART Q<br>SPADE 3<br>SPADE A<br>SPADE 2<br>DIAMOND 2<br>HEART 7<br>HEART Q<br>SPADE 2<br>SPADE 4<br>SPADE A</pre> |
