...
A program that runs infinitely does not end on its own. In your IDE (like IntelliJ or VS Code), it can be shut down by clicking the red button located on the left side of the output window.
